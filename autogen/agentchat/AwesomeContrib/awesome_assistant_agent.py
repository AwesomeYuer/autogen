...
class AwesomeAssistantAgent(AssistantAgent):
    """(Experimental) Awesome Assistant agent, designed to solve a task with LLM.

    AwesomeAssistantAgent is a subclass of AssistantAgent configured with a default system message.
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.register_reply(Agent, AwesomeAssistantAgent._generate_retrieve_assistant_reply)
